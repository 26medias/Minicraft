...
export type BlockDef = {
	...
	solid: boolean;
	transparent: boolean;
	// Rendered in the blended translucent pass (stained glass). Implies transparent.
	translucent: boolean;
...
export const BASE_BLOCKS: BlockDef[] = [
	{ id: 0, name: 'air', label: 'Air', solid: false, transparent: true, translucent: false, group: 'basics', hardness: 0,
		lightLevel: 0, lightFilter: 0, liquid: 'none',
		textures: null },
	{ id: 1, name: 'grass_block', label: 'Grass', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.3,
	...
	{ id: 2, name: 'dirt', label: 'Dirt', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.3,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'dirt' } },
	{ id: 3, name: 'stone', label: 'Stone', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 1.2,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'stone' } },
	{ id: 4, name: 'cobblestone', label: 'Cobblestone', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 1.2,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'cobblestone' } },
	{ id: 5, name: 'sand', label: 'Sand', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.3,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'sand' } },
	{ id: 6, name: 'oak_planks', label: 'Oak Planks', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.8,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
	...
	{ id: 10, name: 'red_wool', label: 'Red Wool', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.5,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'red_wool' } },
	{ id: 11, name: 'blue_wool', label: 'Blue Wool', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.5,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'blue_wool' } },
	{ id: 12, name: 'green_wool', label: 'Green Wool', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.5,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'green_wool' } },
	{ id: 13, name: 'yellow_wool', label: 'Yellow Wool', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.5,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
		textures: { kind: 'uniform', all: 'yellow_wool' } },
	{ id: 14, name: 'black_wool', label: 'Black Wool', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 0.5,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
	...
	{ id: 17, name: 'water', label: 'Water', solid: false, transparent: true, translucent: false, group: 'basics', hardness: 0,
		lightLevel: 0, lightFilter: 2, liquid: 'water',
		textures: { kind: 'uniform', all: 'water_still' } },
	{ id: 18, name: 'lava', label: 'Lava', solid: false, transparent: true, translucent: false, group: 'basics', hardness: 0,
		lightLevel: 12, lightFilter: 3, liquid: 'lava',
		textures: { kind: 'uniform', all: 'lava_still' } },
	{ id: 19, name: 'obsidian', label: 'Obsidian', solid: true, transparent: false, translucent: false, group: 'basics', hardness: 1.2,
		lightLevel: 0, lightFilter: 15, liquid: 'none',
